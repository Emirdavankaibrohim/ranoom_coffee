                ...
                <div class="card ">
                    <div class="card-body">
                        ...
                        <form action="{{ url('admin/password/update/' . auth()->user()->id) }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label for="oldPassword" class="form-label font-medium">Kata Sandi Lama</label>
                            ...
                            <div class="mb-4">
                                <label for="newPassword" class="form-label font-medium">Kata Sandi Baru</label>
                            ...
                            <div class="mb-4">
                                <label for="confirmPassword" class="form-label font-medium">Konfirmasi Kata Sandi</label>
