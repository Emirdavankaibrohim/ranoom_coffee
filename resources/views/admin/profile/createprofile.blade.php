            ...
            <div class="row justify-content-center align-items-center" style="min-height: 80vh;">
                <div class="card shadow col-5">
                    <div class="card-header py-3">
                        <div class="">
                            <div class="">
                                <h3 class="m-0 fw-bold text-center">Tambah Akun Pengguna</h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('profile.addNewUser') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="profile" class="form-label">Profil Pengguna</label>
                                <select id="profile" name="profile" class="form-select">
                                    <option value="admin">Admin</option>
                                    <option value="cashier">Kasir</option>
                                    <option value="chef">Koki</option>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <input type="submit" value="Buat Akun" class="btn btn-coffee w-100">
                        </form>
                    </div>
                </div>
            </div>
