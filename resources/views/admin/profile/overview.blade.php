            ...
            <div class="card shadow-sm" style="border-radius: 8px; max-width: 600px;" >
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex flex-column align-items-center">
                        ...
                        <h4 class="text-center">Nama: {{ auth()->user()->name }}</h4>
                        <p class="text-muted text-center">Peran: {{ old('role', auth()->user()->role) }}</p>
                    </div>

                    <!-- Contact Details Column -->
                    <div class="col-md-5 mt-5">
                        <h5 class="fw-bold mt-3">Detail Kontak</h5>
                        <div class="mt-3">
                            <p class="mb-2">
                ...
                <div class="mt-4">
                    <ul class="nav nav-tabs justify-content-center">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('adminDashboard') }}">Dasbor</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('profile.detail') }}">Akun & Profil</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('passwordpage') }}">Ubah Kata Sandi</a>
                        </li>
                    </ul>
                </div>
            </div>
