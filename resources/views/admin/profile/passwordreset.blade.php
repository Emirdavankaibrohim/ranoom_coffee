    ...
    <div class="container-fluid justify-content-center align-items-center p-4">
        ...
        <div class="card shadow  mb-4 mt-4 col-lg-6 col-md-8 col-12 mx-auto" >
            <div class="card-header py-3">
                    <h3 class="m-0 fw-bold text-dark text-center">Reset Kata Sandi</h3>
            </div>
            ...
            <form action="{{ route('resetPassword') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="submit" value="Reset Kata Sandi" class="btn btn-primary w-100">
                        </div>
                        <div class="col-6">
                            <a href="{{ route('adminDashboard') }}" class="btn btn-secondary w-100 text-center">Batal</a>
                        </div>
                    </div>
                </div>
            </form>
