...
<body class="body">
        ...
        @if (auth()->check())
            ...
            @if (auth()->user()->role === 'admin' || auth()->user()->role === 'cashier')
                <button class="btn d-flex justify-content-between align-items-center mb-2"
                    ...
                    <span><i class="fa-solid fa-gears me-2"></i> Pengaturan</span>
            ...
            <button class="btn d-flex justify-content-between align-items-center mb-2"
                    ...
                    style="background-color: #66401d; color: white;">
                    <span><i class="fa-solid fa-bag-shopping me-2"></i>Manajemen Pembelian</span>
                    <i class="bi bi-chevron-down"></i>
                </button>
                <ul class="purchasemenu list-unstyled">
                    <li><a href="{{ route('supplier.index') }}" class="btn mb-2" style="background-color: #f1e797; color: black;">
                        <i class="fa-solid fa-circle-info me-2"></i>Informasi Supplier</a></li>
                    <li><a href="{{ route('purchasePage') }}" class="btn mb-2" style="background-color: #f1e797; color: black;">
                        <i class="fa-solid fa-basket-shopping me-2"></i>Informasi Pembelian</a></li>
                ...
                <button class="btn d-flex justify-content-between align-items-center mb-2"
                    ...
                    style="background-color: #66401d; color: white;">
                    <span><i class="fa-sharp-duotone fa-solid fa-house me-2"></i>Manajemen Aset</span>
                    <i class="bi bi-chevron-down"></i>
                </button>
                <ul class="assetmenu list-unstyled">
                    <li><a href="{{ route('assetCategories.index')}}" class="btn mb-2" style="background-color: #f1e797; color: black;">
                        <i class="fa-solid fa-layer-group me-2"></i>Kategori aset</a></li>
                    <li><a href="{{ route('assets.index')}}" class="btn mb-2" style="background-color: #f1e797; color: black;">
                        <i class="fa-solid fa-list me-2"></i>Daftar Aset</a></li>
                ...
                style="background-color: #66401d; color: white;">
                <span><i class="fa-solid fa-user-gear me-2"></i> Kelola Profil</span>
                <i class="bi bi-chevron-down"></i>
            </button>
    ...
    <div class="w-100 px-3 d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand text-light fw-bold ms-4" href="{{ route('dashboard') }}">
            <i class="fas fa-store"></i> Ranoom Coffee
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav align-items-center">
                <li class="nav-item">
                    <a href="{{ route('order.orderlist') }}" class="nav-link text-light position-relative me-4">Pesanan
                        @if(($orderPending ?? 0) > 0)
                ...
                <li class="nav-item">
                    <a class="nav-link text-light me-2" href="{{ route('paymentRecord') }}">Faktur</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('profile.overview') }}">Profil</a></li>
                        <li><a class="dropdown-item" href="{{ route('passwordpage') }}">Reset Kata Sandi</a></li>
                        <li>
