...
<div class="container mt-3">
    <div class="card shadow-lg p-4 supplier">
        <h2 class="fw-bold text-center">Daftar Supplier</h2>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <form action="" method="get" class="d-flex">
                <input type="text" name="searchKey" class="form-control me-1" placeholder="Cari Supplier..." value="{{ request('searchKey') }}">
        ...
        <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-footer bg-light d-flex justify-content-between">
                            ...
                            <form action="{{ route('deleteSupplier', $item->id ) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                @csrf
                                @method('DELETE')
            ...
            @empty
                <p class="text-center">Data supplier tidak ditemukan.</p>
            @endforelse
        </div>
