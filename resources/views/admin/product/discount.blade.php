    ...
    <div class="row justify-content-center mt-3">
        <div class="col-md-6">
            <div class="card shadow-lg p-2">
                <div class="card-body">
                    <h3 class="text-dark fw-bold mb-4 text-center">Tambah Diskon</h3>
                    ...
                    <form action="{{ route('adddiscount') }}" method="POST">
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="apply_to_all">Terapkan diskon ke semua produk</label>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" name="discount_percentage" id="discount_percentage" class="form-control @error('discount_percentage') is-invalid @enderror" min="0" max="100" placeholder="Masukkan persentase diskon">
                        ...
                        <button type="submit" class="btn btn-primary w-100 shadow-sm">Buat Diskon</button>
                    </form>
                    <!-- Form Ends Here -->
                </div>
            </div>
