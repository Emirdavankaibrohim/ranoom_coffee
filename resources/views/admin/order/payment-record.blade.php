            ...
            <div class="col-md-6">
                <div class="card-body mt-2">
                    ...
                    <div class="payment-card p-4 shadow-lg rounded-3" style="background-color: #50301a;">
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <form action="{{ route('searchRecord') }}" method="GET">
                                    <label for="orderCode" class="form-label text-white">Cari…</label>
                        ...
                        @if ($records->isEmpty())
                            <small class="text-light">Tidak ada data yang ditemukan. Silakan cari menggunakan Kode
                                Pesanan.</small>
                        @else
                            <!-- Payment Slip Table -->
                            <div class="slip-container bg-white text-black rounded-3">
                                <div class="text-center mb-3">
                                    <h5 style="margin: 0; font-weight: bold;">Slip Pembayaran</h5>
                                </div>
                                <div>
                                ...
                                <table style="width: 100%; margin-top: 10px; border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center; border-bottom: 1px solid #000;">Jumlah</th>
                                            <th style="text-align: right; border-bottom: 1px solid #000;">Harga</th>
                                            <th style="text-align: right; border-bottom: 1px solid #000;">Ukuran</th>
                                            <th style="text-align: right; border-bottom: 1px solid #000;">Diskon</th>
                                    ...
                                    <tbody>
                                        @foreach ($records as $item)
                                            <tr>
                                                ...
                                                <td style="text-align: right;">{{ strtoupper(substr($item->size, 0, 1)) }}
                                                </td>
                                ...
                                <div style="border-top: 1px solid #000; margin-top: 10px; padding-top: 5px;">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <tr>
                                            ...
                                            <td style="text-align: right;">{{ number_format($subTotalAmt, 2, '.', ',') }}
                                            </td>
                                        </tr>
                                        {{-- <tr>
                                        ...
                                        <tr>
                                            <td style="text-align: left;">Biaya Pengiriman:</td>
                                            <td style="text-align: right;">{{ number_format($delivery_fee, 2, '.', ',') }}
                                            </td>
                                        </tr>
                                        <tr style="font-weight: bold;">
                                            <td style="text-align: left;">Jumlah Bersih</td>
                                            <td style="text-align: right;">
                                ...
                                <div style="border-top: 1px solid #000; margin-top: 10px; padding-top: 5px;">
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <tr>
                                            <td style="text-align: left;">Jumlah Dibayar</td>
                                            <td style="text-align: right;">{{ $records->first()->paid_amount }}</td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: left;">Ubah</td>
                                            <td style="text-align: right;">{{ $records->first()->change_amount }}</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="text-center" style="font-weight: bold;">Terima Kasih</div>
                            </div>
                        @endif
                    </div>
...
@section('scripts')
    <script>
        document.getElementById('printButton').addEventListener('click', function() {
            ...
            const printWindow = window.open(`/admin/order/printPaymentSlip/${orderCode}`, "_blank",
