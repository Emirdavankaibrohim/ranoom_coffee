<div class="card shadow-sm p-4 rounded-4">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label for="assigned_user_id" class="form-label fw-semibold">Petugas</label>
        ...
        <div class="col-md-6">
            <label for="asset_category_id" class="form-label fw-semibold">Kategori</label>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <label for="purchase_value" class="form-label fw-semibold">Nilai Pembelian</label>
            <input type="number" step="0.01" name="purchase_value" value="{{ old('purchase_value', $asset->purchase_value ?? '') }}" class="form-control">
        </div>

        <div class="col-md-6">
            <label for="depreciation_rate" class="form-label fw-semibold">Tingkat Penyusutan (%)</label>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <select name="status" class="form-select" required>
                <option value="Aktif" {{ old('status', $asset->status ?? '') == 'active' ? 'selected' : '' }}>Aktif</option>
                <option value="Nonaktif" {{ old('status', $asset->status ?? '') == 'inactive' ? 'selected' : '' }}>Nonaktif</option>
                <option value="Dihentikan" {{ old('status', $asset->status ?? '') == 'retired' ? 'selected' : '' }}>Dihentikan</option>
            </select>
        </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <label for="warranty_expiry_date" class="form-label fw-semibold">Tanggal Kedaluwarsa</label>
